// @name: MessagePack.js
// @require: Valid.js, WordArray.js, UTF8.js
// @cutoff: @assert @node
...
var WordArray = global["WordArray"] || require("uupaa.wordarray.js");
...
function _rawEncode(view, offset, bufferSize, source, depth) {
    ...
    case "boolean": view[offset++] = source ? 0xc3 : 0xc2; return offset;
...
function _rawPackString(view, offset, bufferSize, source) {
    var ary = UTF8["encode"](WordArray["fromString"](source));
    var size = ary.length;
...
function _decodeUTF8(view, offset, size) {
    return WordArray["toString"]( UTF8["decode"]( view.subarray(offset, offset + size) ) );
}
